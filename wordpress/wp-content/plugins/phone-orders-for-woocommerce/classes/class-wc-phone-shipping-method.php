...
class WC_Phone_Shipping_Method extends WC_Shipping_Method {
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = __( 'Free Shipping in admin area only, for Phone Orders ', 'phone-orders-for-woocommerce' ); 
		$this->supports              = array(
			'shipping-zones',
			'instance-settings',
	...
	function init_form_fields() { 
		$this->form_fields = array(
			'title' => array(
				...
				'type' => 'text',
				'description' => __( 'Title to be display on site', 'phone-orders-for-woocommerce' ),
